...
app.layout = html.Div([
    ...
    html.Div(id='output-container', className='chart-grid', style={'display': 'inline-block'}),])
])
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        R_chart4 = dcc.Graph(figure=px.bar(unemployment_sales,
                                            x= 'Vehicle_Type',
                                            y='Automobile_Sales',
...
#TASK 2.6: Returning the graphs for displaying Yearly data
        return [
                html.Div(className='chart-item', children=[html.Div(Y_chart1),html.Div(Y_chart2)],style={'display': 'inline-block'}),
                html.Div(className='chart-item', children=[html.Div(Y_chart3),html.Div(Y_chart4)],style={'display': 'inline-block'})
                ]
